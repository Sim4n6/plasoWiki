...
--- | --- | --- 
[![Build Status](https://travis-ci.org/log2timeline/plaso.svg?branch=master)](https://travis-ci.org/log2timeline/plaso) | [![Build status](https://ci.appveyor.com/api/projects/status/g3x5ylegjjo61p4m?svg=true)](https://ci.appveyor.com/project/joachimmetz/plaso) | [![Coverage Status](https://coveralls.io/repos/log2timeline/plaso/badge.svg?branch=master&service=github)](https://coveralls.io/github/log2timeline/plaso?branch=master)
